...
<html lang="pt-br">
  ...
  <?php
        ...
        $result = $mysqli->query("SELECT * FROM nota") or die ($mysqli->error);
        //pre_r($result);
      ?>
   ...
   <div class=" row justify-content-center">
    ...
    <input type="hidden" name="id" value="<?php echo $id; ?>">
     <div class="form-group">
      <label>AVP1:</label>
       <input type="number" class="form-control" value="<?php echo $nota1; ?>" name="nota1">
       </div>
       <div class="form-group">
       <label>AVP2:</label>
       <input type="number" class="form-control" value="<?php echo $nota2; ?>" name="nota2">
       </div>    
        <div class="form-group">
       <label>Digite o ID da Disciplina:</label>
       <input type="number" class="form-control" value="<?php echo $id_disciplina; ?>" name="id_disciplina">
       </div>
       <div class="form-group">
